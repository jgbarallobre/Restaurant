...
<head>
    ...
    <title><?php echo $es_edicion ? 'Editar' : 'Nuevo'; ?> Producto - Sistema POS</title>
        ...
        <div class="main-content">
            ...
            <main class="content">
                <div class="container-fluid">
                    <h4 class="mb-4"><i class="bi bi-<?php echo $es_edicion ? 'pencil' : 'plus-lg'; ?> me-2"></i><?php echo $es_edicion ? 'Editar' : 'Nuevo'; ?> Producto</h4>
                    ...
                    <form method="POST" action="acciones.php" enctype="multipart/form-data" id="formProducto">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select name="tipo_producto" class="form-select" id="tipoProducto" required <?php echo $es_edicion ? 'disabled' : ''; ?>>
                                                <option value="">Seleccionar...</option>
                                                <option value="materia_prima" <?php echo ($producto && $producto['tipo_producto'] === 'materia_prima') ? 'selected' : ''; ?>>Materia Prima</option>
                                                <option value="terminado" <?php echo ($producto && $producto['tipo_producto'] === 'terminado') ? 'selected' : ''; ?>>Producto Terminado</option>
                                                <option value="compuesto" <?php echo ($producto && $producto['tipo_producto'] === 'compuesto') ? 'selected' : ''; ?>>Producto Compuesto</option>
                                            </select>
                                            <?php if ($es_edicion): ?>
                                            <input type="hidden" name="tipo_producto" value="<?php echo $producto['tipo_producto']; ?>">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="descripcion" class="form-control" rows="2"><?php echo $producto ? htmlspecialchars($producto['descripcion']) : ''; ?></textarea>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="categoria_id" class="form-select">
                                                ...
                                                <option value="<?php echo $c['id']; ?>" <?php echo ($producto && $producto['categoria_id'] == $c['id']) ? 'selected' : ''; ?>>
                                                    <?php echo $c['nombre']; ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="precio_usd" class="form-control" required step="0.01" min="0.01" 
                                                       value="<?php echo $producto ? $producto['precio_base_usd'] : '0.00'; ?>">
                                            </div>
                                            <small class="text-muted">equivale a: <span id="precioBs">0,00</span> Bs</small>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select name="unidad_medida" class="form-select" id="unidadMedida">
                                                <option value="unidad" <?php echo ($producto && $producto['unidad_medida'] === 'unidad') ? 'selected' : ''; ?>>Unidad</option>
                                                <option value="kg" <?php echo ($producto && $producto['unidad_medida'] === 'kg') ? 'selected' : ''; ?>>Kilogramo (kg)</option>
                                                <option value="gramos" <?php echo ($producto && $producto['unidad_medida'] === 'gramos') ? 'selected' : ''; ?>>Gramos (g)</option>
                                                <option value="litros" <?php echo ($producto && $producto['unidad_medida'] === 'litros') ? 'selected' : ''; ?>>Litros (L)</option>
                                                <option value="ml" <?php echo ($producto && $producto['unidad_medida'] === 'ml') ? 'selected' : ''; ?>>Mililitros (ml)</option>
                                                <option value="paquete" <?php echo ($producto && $producto['unidad_medida'] === 'paquete') ? 'selected' : ''; ?>>Paquete</option>
                                                <option value="porcion" <?php echo ($producto && $producto['unidad_medida'] === 'porcion') ? 'selected' : ''; ?>>Porción</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="stock_minimo" class="form-control" step="0.01" min="0" 
                                                   value="<?php echo $producto ? $producto['stock_minimo'] : '0'; ?>">
                                        </div>
                                    </div>
                                </div>
                                
                                <!-- Campos específicos para materia prima -->
                                <div id="camposMP" style="display: none;">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label">Stock Actual</label>
                                                <input type="number" name="stock_actual" class="form-control" step="0.01" min="0" 
                                                       value="<?php echo $producto ? $producto['stock_actual'] : '0'; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="costo" class="form-control" step="0.01" min="0" 
                                                           value="<?php echo $producto ? $producto['precio_base_usd'] : '0'; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="camposTerminado" style="display: none;">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label">Stock Actual</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="codigo_barras" class="form-control" 
                                                       value="<?php echo $producto ? htmlspecialchars($producto['descripcion'] ?? '') : ''; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="camposCompuesto" style="display: none;">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                        ...
                        <div class="card mb-4" id="seccionReceta" style="display: none;">
